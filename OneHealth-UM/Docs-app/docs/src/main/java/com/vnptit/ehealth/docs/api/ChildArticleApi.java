...
public class ChildArticleApi extends BaseApi<ChildArticleEntity> {
    private final ChildArticleService childArticleService;

    public ChildArticleApi(ChildArticleService childArticleService) {
        this.childArticleService = childArticleService;
    }
